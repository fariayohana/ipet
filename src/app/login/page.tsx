      ...
      <div className="max-w-md w-full space-y-8">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-700 font-semibold">Ou continue com</span>
              </div>
            </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-800 font-semibold">
            É uma petshop?{' '}
            <Link href="/petshop/register" className="font-bold text-orange-500 hover:text-orange-600">
              Cadastre sua petshop aqui
            </Link>
          </p>
        </div>
      </div>
